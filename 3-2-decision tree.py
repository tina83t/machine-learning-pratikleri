...
print("egitilet dt modeli dogrulamasi", accuracy)
...
plt.plot(X_test, y_pred_1, color= "blue", label = "Max xDepth:2 ")
plt.plot(X_test, y_pred_2, color= "green", label = "Max xDepth:5 ")
